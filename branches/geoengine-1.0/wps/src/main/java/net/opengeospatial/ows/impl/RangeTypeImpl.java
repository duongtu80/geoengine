 ...
 */
public class RangeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengeospatial.ows.RangeType
{
    ...
    public net.opengeospatial.ows.ValueType getMaximumValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengeospatial.ows.ValueType target = null;
            target = (net.opengeospatial.ows.ValueType)get_store().find_element_user(MAXIMUMVALUE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setMaximumValue(net.opengeospatial.ows.ValueType maximumValue)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengeospatial.ows.ValueType)get_store().add_element_user(MAXIMUMVALUE$2);
            }
    ...
    public net.opengeospatial.ows.ValueType getSpacing()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengeospatial.ows.ValueType target = null;
            target = (net.opengeospatial.ows.ValueType)get_store().find_element_user(SPACING$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setSpacing(net.opengeospatial.ows.ValueType spacing)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengeospatial.ows.ValueType)get_store().add_element_user(SPACING$4);
            }
            target.set(spacing);
        }
    }
    ...
    public net.opengeospatial.ows.RangeClosureAttribute.RangeClosure xgetRangeClosure()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengeospatial.ows.RangeClosureAttribute.RangeClosure)get_store().find_attribute_user(RANGECLOSURE$6);
            if (target == null)
            {
                target = (net.opengeospatial.ows.RangeClosureAttribute.RangeClosure)get_default_attribute_value(RANGECLOSURE$6);
            }
            return target;
        }
    }
    ...
    public void xsetRangeClosure(net.opengeospatial.ows.RangeClosureAttribute.RangeClosure rangeClosure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengeospatial.ows.RangeClosureAttribute.RangeClosure)get_store().add_attribute_user(RANGECLOSURE$6);
            }
