 ...
 */
public class ExceptionTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.ows.x11.ExceptionType
{
    ...
    private static final javax.xml.namespace.QName EXCEPTIONTEXT$0 = 
        new javax.xml.namespace.QName("http://www.opengis.net/ows/1.1", "ExceptionText");
