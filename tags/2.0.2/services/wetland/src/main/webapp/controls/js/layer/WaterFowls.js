 ...
 */
OpenLayers.Layer.WaterFowls = OpenLayers.Class(OpenLayers.Layer.Markers, {
        ...
        for (var i=0, len=features.length; i<len; i++) {
            ...
            if ((feature.attributes.title != null) 
                ...
                data['popupContentHTML'] = 
                    '<div class="olLayerWaterFowlsTitle">'+feature.attributes.title+'</div>' + 
                    '<div class="olLayerWaterFowlsText">'+feature.attributes.description+'</div>';
            }
            
            data.popupSize = new OpenLayers.Size(200, 80);
...
//
    ...
    CLASS_NAME: "OpenLayers.Layer.WaterFowls"
});
