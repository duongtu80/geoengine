			...
			<tr>
				...
				<td id="rightPanel">
					<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
						...
						<div class="viewItem"><div class="viewTitle1">流域</div><div><input id="listCatchment" jsId='listCatchment' dojoType="dijit.form.ComboBox" style="width: 150px;" onchange="glacier.selectBasin();"></input></div></div>
					</div>
					<button dojoType="dijit.form.Button" onclick="glacier.selectWpsModel();">加载模型</button>
					<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
							<div class="viewItem"><div class="viewTitle">气温插值</div><input id="modelTemperature" dojoType="dijit.form.ComboBox" style="width: 160px;" onchange="glacier.changeModel('modelTemperature');"></input><a class="settingParameter" href="#" onclick="glacier.modelSetting('modelTemperature');">修改参数</a></div>
						</div>
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
							<div class="viewItem"><div class="viewTitle">降水插值</div><input id="modelPrecipitation" dojoType="dijit.form.ComboBox"  style="width: 160px;" onchange="glacier.changeModel('modelPrecipitation');"></input><a class="settingParameter" href="#" onclick="glacier.modelSetting('modelPrecipitation');">修改参数</a></div>
						</div>
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
							<div class="viewItem"><div class="viewTitle">雪度日因子</div><input id="modelSnowDdf" dojoType="dijit.form.ComboBox"  style="width: 160px;" onchange="glacier.changeModel('modelSnowDdf');"></input><a class="settingParameter" href="#" onclick="glacier.modelSetting('modelSnowDdf');">修改参数</a></div>
						</div>
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
							<div class="viewItem"><div class="viewTitle">冰度日因子</div><input id="modelIceDdf" dojoType="dijit.form.ComboBox"  style="width: 160px;" onchange="glacier.changeModel('modelIceDdf');"></input><a class="settingParameter" href="#" onclick="glacier.modelSetting('modelIceDdf');">修改参数</a></div>
						</div>
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
							<div class="viewItem"><div class="viewTitle">径流模型</div><input id="modelRunoff" dojoType="dijit.form.ComboBox"  style="width: 160px;" onchange="glacier.changeModel('modelRunoff');"></input><a class="settingParameter" href="#" onclick="glacier.modelSetting('modelRunoff');">修改参数</a></div>
						</div>
						<div class="blockBody" style="border: 1px solid #EEEEEE; margin: 1px; padding: 2px;">
