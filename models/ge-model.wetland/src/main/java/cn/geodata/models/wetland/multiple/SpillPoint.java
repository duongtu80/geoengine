...
public class SpillPoint {
	 ...
	 * @throws IOException
	 */
	public static SpillPoint calculateSpillPoint(GeoRaster dem, List<Catchment> catchmentsAll, List<Catchment> catchments) throws IOException{
...
//		double _spillPoint = _raster.readFloat(_lowestB.getRow(), _lowestB.getCol()) - _raster.readFloat(_lowestC.getRow(), _lowestC.getCol());
	 ...
	 * @throws IOException
	 */
	public static SpillPoint calculateSpillPoint(GeoRaster dem, List<Catchment> catchmentsAll, Catchment catchment) throws IOException{
