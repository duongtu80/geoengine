 ...
 */
public class ResponsiblePartySubsetTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.ows.x11.ResponsiblePartySubsetType
{
    ...
    public net.opengis.ows.x11.ContactType getContactInfo()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.ows.x11.ContactType)get_store().find_element_user(CONTACTINFO$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setContactInfo(net.opengis.ows.x11.ContactType contactInfo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.ows.x11.ContactType)get_store().add_element_user(CONTACTINFO$4);
            }
    ...
    public net.opengis.ows.x11.CodeType getRole()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.ows.x11.CodeType)get_store().find_element_user(ROLE$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setRole(net.opengis.ows.x11.CodeType role)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.ows.x11.CodeType)get_store().add_element_user(ROLE$6);
            }
            target.set(role);
        }
    }
