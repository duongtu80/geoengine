...
public class Utilities {
	...
	public static void saveRaster(File file, WritableRaster raster, Envelope2D extent) throws IOException{
		GridCoverage2D _gc = (CoverageFactoryFinder.getGridCoverageFactory(GeoTools.getDefaultHints())).create("raster", raster, extent); // new GridCoverage2D("test", _image, _geo, null, null, null);
//		
