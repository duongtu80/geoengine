		...
		<div id="mainPanel">
			...
			<tr>
				...
				<td id="rightPanel">
					...
					<div class="textBlock">
						Albedo <input type="text" id='ET.Albedo' value="0.08" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 50px;" />
						Wind Speed <input type="text" id='ET.WindSpeed' value="1" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 50px;" />
					</div>
					<div class="textBlock">
						Coefficient <input type="text" id='ET.Coefficient' value="1.2" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 50px;" />
					</div>
					<div class="blockTitle">WaterTable Model Parameters</div>
					<div class="textBlock">
						Spill Point <input type="text" id='WT.SpillPoint' value="3" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 40px;" />
						Catchment Area <input type="text" id='WT.CatchmentArea' value="3" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 40px;" />
					</div>
					<div class="textBlock">
						Saturation Prcp <input type="text" id='WT.SaturationPrcp' value="0.003" dojoType='dijit.form.NumberTextBox' trim='true' required='true' style="width: 50px;" />
					</div>
					<div class="textBlock">
